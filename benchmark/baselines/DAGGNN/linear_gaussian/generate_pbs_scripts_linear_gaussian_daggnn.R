...
path_results_root <- "results/continuous/linear_gaussian/DAGGNN" 

output_dir <- "job_scripts/DAGGNN/linear_gaussian"
  ...
  for (degree in average_degrees) {
    for (group_name in names(sample_groups)) {
        ...
        script_content <- c(
          ...
          "",
          "Rscript /baselines/DAGGNN/linear_gaussian/simulate_linear_gaussian_data_hpc.R \\",
